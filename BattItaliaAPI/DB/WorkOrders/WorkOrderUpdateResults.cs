...
{
    [Serializable]
    public partial class WorkOrderUpdateResults
    {
    ...
    public partial class WorkOrderUpdate
    {
        WorkOrderUpdateResults CreatePoco(System.Data.IDataRecord record)
        {
            return new WorkOrderUpdateResults();
        }
    }
}
