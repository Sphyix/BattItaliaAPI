...
{
    [Serializable]
    public partial class WorkOrder_UserInsertResults
    {
    ...
    public partial class WorkOrder_UserInsert
    {
        WorkOrder_UserInsertResults CreatePoco(System.Data.IDataRecord record)
        {
            return new WorkOrder_UserInsertResults();
        }
    }
}
