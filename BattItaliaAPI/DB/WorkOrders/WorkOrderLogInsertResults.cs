...
{
    [Serializable]
    public partial class WorkOrderLogInsertResults
    {
    ...
    public partial class WorkOrderLogInsert
    {
        WorkOrderLogInsertResults CreatePoco(System.Data.IDataRecord record)
        {
            return new WorkOrderLogInsertResults();
        }
    }
}
