...
{
    [Serializable]
    public partial class WorkOrderInsertResults
    {
    ...
    public partial class WorkOrderInsert
    {
        WorkOrderInsertResults CreatePoco(System.Data.IDataRecord record)
        {
            return new WorkOrderInsertResults();
        }
    }
}
