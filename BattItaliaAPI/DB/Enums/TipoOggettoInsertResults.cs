...
{
    [Serializable]
    public partial class TipoOggettoInsertResults
    {
    ...
    public partial class TipoOggettoInsert
    {
        TipoOggettoInsertResults CreatePoco(System.Data.IDataRecord record)
        {
            return new TipoOggettoInsertResults();
        }
    }
}
