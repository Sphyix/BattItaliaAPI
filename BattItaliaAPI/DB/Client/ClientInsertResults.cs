...
{
    [Serializable]
    public partial class ClientInsertResults
    {
    ...
    public partial class ClientInsert
    {
        ClientInsertResults CreatePoco(System.Data.IDataRecord record)
        {
            return new ClientInsertResults();
        }
    }
}
